...
<span style="color:var(--bs-primary);">
  <svg width="30" height="24" viewbox="0 0 250 196" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path fill-rule="evenodd" clip-rule="evenodd" d="M237.721 1.18923L125 70.3075V136.87L250 65.2465V8.06814C250 3.61223 246.389 0 241.935 0C240.448 0 238.99 0.411583 237.721 1.18923Z" fill="white" fill-opacity="0.3"></path>
      ...
      <span class="app-brand-text demo menu-text fw-semibold ms-2">TEST Admin</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item " :class=" $route.path=='/store'?'active':'' ">
      <router-link to="/store" class="menu-link">
        <i class="menu-icon tf-icons ri-database-fill"></i>
        <div data-i18n="Dashboards">Store</div>
...
<li class="menu-item" :class=" $route.path=='/transection'?'active':'' ">
    ...
    <li class="menu-item" :class=" $route.path=='/report'?'active':'' ">
      <router-link to="/report" class="menu-link">
        <i class="menu-icon tf-icons ri-funds-box-fill"></i>
